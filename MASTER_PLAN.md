...
| Area                      | State            | Notes                                                                                                                                |
| ------------------------- | ---------------- | ------------------------------------------------------------------------------------------------------------------------------------ |
| M0 Discovery and planning | COMPLETED        | M0 Markdown project-memory baseline committed and pushed to `origin/main`.                                                           |
| M1 Foundation             | READY_FOR_REVIEW | Monorepo foundation, app shells, contracts skeleton, Supabase config, CI, env templates, and checks are complete on `m1-foundation`. |
...
| ------------------------------------------------- | ---------------- | --------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------- |
| M0 Discovery and planning                         | COMPLETED        | Repository assessment, architecture, project-memory files, risks, decisions, and approval gates.                                              | User approved M1 start. |
| M1 Monorepo and engineering foundation            | READY_FOR_REVIEW | Flutter shell, admin shell, shared packages, Supabase local environment, CI, environment handling, and test foundation.                       | User approves M2.       |
